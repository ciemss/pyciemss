...
def time_and_state_dependent_intervention_builder(name, f, tspan):
    """
    'f(t, x)' is a function from time and the value of the variable at trace address 'name' to the
    intervention assignment. Note that the first argument of `f` must be time.
    """

...
def is_intervention_density_equal(
    model1: callable, model2: callable, intervention: dict, num_samples: int = 1000
):
    ...
    return is_density_equal(
        intervene(model1, intervention), intervene(model2, intervention), num_samples
    )

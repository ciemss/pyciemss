...
start_time = 0.0
end_time = 100
model1 = "/Users/oost464/Local_Project/SEIRHD_NPI_Type1_petrinet.json"
...
gamma_values = np.linspace(0.1, 0.3, 10)
...
shap_values_filename = os.path.join(os.path.dirname(__file__), f'shap_values_{current_time}.csv')

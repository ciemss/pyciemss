...
<!-- generated with COPASI 4.24 (Build 197) (http://www.copasi.org) at 2018-10-17 15:30:16 UTC -->
...
Reaction scheme where the products are created from the reactants and the change of a product quantity is proportional to the product of reactant activities. The reaction scheme does not include any reverse process that creates the reactants from the products. The change of a product quantity is proportional to the quantity of one reactant.
    ...
    <Function key="Function_40" name="Rate for reaction 3 [1]" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_40">
    ...
    <Function key="Function_41" name="Rate for reaction 8 [2]" type="UserDefined" reversible="unspecified">
      <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Function_41">
    <dcterms:created>
      ...
      <ListOfParameterDescriptions>
        <ParameterDescription key="FunctionParameter_265" name="beta_bh" order="0" role="constant"/>
        <ParameterDescription key="FunctionParameter_250" name="S_h" order="1" role="substrate"/>
        <ParameterDescription key="FunctionParameter_261" name="I_b" order="2" role="modifier"/>
      </ListOfParameterDescriptions>
    </Function>
  </ListOfFunctions>
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_0">
    ...
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2018-09-17T10:50:01Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
...
<rdf:RDF xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#" xmlns:bqbiol="http://biomodels.net/biology-qualifiers/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Compartment_1">
    ...
    <dcterms:created>
      <rdf:Description>
        <dcterms:W3CDTF>2018-09-17T10:50:47Z</dcterms:W3CDTF>
      </rdf:Description>
    </dcterms:created>
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:obi:OBI:0000181" />
  </rdf:Description>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Metabolite_1">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:ido:0000511"/>
      ...
      <Metabolite key="Metabolite_2" name="Susceptible human (S_h)" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:bqbiol="http://biomodels.net/biology-qualifiers/"
  ...
  <rdf:Description rdf:about="#Metabolite_2">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:ido:0000514"/>
      ...
      <Metabolite key="Metabolite_3" name="Infected Human (I_a)" simulationType="reactions" compartment="Compartment_1" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:bqbiol="http://biomodels.net/biology-qualifiers/"
  ...
  <rdf:Description rdf:about="#ModelValue_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          &lt;CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Susceptible human (S_h)],Reference=Concentration>+&lt;CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Infected Human (I_a)],Reference=Concentration>
        </Expression>
      </ModelValue>
...
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#ModelValue_16">
    ...
    <ListOfReactions>
      <Reaction key="Reaction_0" name="Birth of susceptible bird" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF xmlns:dcterms="http://purl.org/dc/terms/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_0">
    <dcterms:created>
      ...
      <Reaction key="Reaction_1" name="Natural death of susceptible bird" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_1">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
      ...
      <Reaction key="Reaction_2" name="Infection of susceptible bird" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_2">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:ncit:C128320"/>
      ...
      <Reaction key="Reaction_3" name="Disease related death of infected bird" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_3">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5795" name="k1" value="0.00346709"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Bird Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_4" name="Natural death of infected bird" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_4">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5797" name="k1" value="0.00136986"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Bird Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_5" name="Birth of susceptible human" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:dcterms="http://purl.org/dc/terms/"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  <rdf:Description rdf:about="#Reaction_5">
    <dcterms:created>
      <rdf:Description>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5796" name="v" value="11.1667"/>
        </ListOfConstants>
        <KineticLaw function="Function_6" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Human Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_49">
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_6">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5799" name="k1" value="3.95914e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Human Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_7" name="Infection of susceptible human" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_7">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:ncit:C128320"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5802" name="beta_bh" value="1.62354e-10"/>
        </ListOfConstants>
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Reaction_8">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5793" name="k1" value="6.08828e-11"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Human Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
      ...
      <Reaction key="Reaction_9" name="Natural death of infected human" reversible="false" fast="false" addNoise="false">
        <MiriamAnnotation>
<rdf:RDF
   xmlns:CopasiMT="http://www.copasi.org/RDF/MiriamTerms#"
   xmlns:dcterms="http://purl.org/dc/terms/"
  ...
  <rdf:Description rdf:about="#Reaction_9">
    ...
    <CopasiMT:isVersionOf rdf:resource="urn:miriam:efo:0000480"/>
        ...
        <ListOfConstants>
          <Constant key="Parameter_5791" name="k1" value="3.95914e-05"/>
        </ListOfConstants>
        <KineticLaw function="Function_13" unitType="Default" scalingCompartment="CN=Root,Model=New Model,Vector=Compartments[Human Population]">
          <ListOfCallParameters>
            <CallParameter functionParameter="FunctionParameter_80">
    ...
    <ListOfModelParameterSets activeSet="ModelParameterSet_0">
      <ModelParameterSet key="ModelParameterSet_0" name="Initial State">
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          ...
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Susceptible human (S_h)]" value="1.035669718164289e+26" type="Species" simulationType="reactions"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Infected Human (I_a)]" value="0" type="Species" simulationType="reactions"/>
        </ModelParameterGroup>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Birth of susceptible bird]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Birth of susceptible bird],ParameterGroup=Parameters,Parameter=v" value="5.6438356164383565" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[LAMBDA_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of susceptible bird]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of susceptible bird],ParameterGroup=Parameters,Parameter=k1" value="0.0013698630136986301" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[mu_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Infection of susceptible bird]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Infection of susceptible bird],ParameterGroup=Parameters,Parameter=beta_b" value="0.0034673126941516751" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[beta_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Disease related death of infected bird]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Disease related death of infected bird],ParameterGroup=Parameters,Parameter=k1" value="0.0034670850058933309" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[delta_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of infected bird]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of infected bird],ParameterGroup=Parameters,Parameter=k1" value="0.0013698630136986301" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[mu_b],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Birth of susceptible human]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Birth of susceptible human],ParameterGroup=Parameters,Parameter=v" value="11.166725753424657" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[LAMBDA_h],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of susceptible human]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of susceptible human],ParameterGroup=Parameters,Parameter=k1" value="3.9591416580885267e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[mu_h],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Infection of susceptible human]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Infection of susceptible human],ParameterGroup=Parameters,Parameter=beta_bh" value="1.6235413495687468e-10" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[beta_bh],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Disease related death of infected human]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Disease related death of infected human],ParameterGroup=Parameters,Parameter=k1" value="6.0882800608828003e-11" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[d],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of infected human]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Natural death of infected human],ParameterGroup=Parameters,Parameter=k1" value="3.9591416580885267e-05" type="ReactionParameter" simulationType="assignment">
              <InitialExpression>
                &lt;CN=Root,Model=New Model,Vector=Values[mu_h],Reference=InitialValue>
              </InitialExpression>
            </ModelParameter>
    ...
    <PlotSpecification name="Concentrations, Volumes, and Global Quantity Values" type="Plot2D" active="1" taskTypes="">
      ...
      <ListOfPlotItems>
        ...
        <PlotItem name="[S_h]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Susceptible human (S_h)],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
        <PlotItem name="[I_a]" type="Curve2D">
          ...
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Reference=Time"/>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Compartments[Human Population],Vector=Metabolites[Infected Human (I_a)],Reference=Concentration"/>
          </ListOfChannels>
        </PlotItem>
  ...
  <SBMLReference file="BI reactions.xml">
    ...
    <SBMLMap SBMLid="Human_Population" COPASIkey="Compartment_1"/>
    ...
    <SBMLMap SBMLid="Rate_for_reaction_3__1" COPASIkey="Function_40"/>
    <SBMLMap SBMLid="Rate_for_reaction_8__2" COPASIkey="Function_41"/>
